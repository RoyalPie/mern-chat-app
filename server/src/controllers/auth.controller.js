...
export const login = async (req, res) => {
  ...
  try {
    ...
    console.log("Error in login controller", error.messasge);
    res.status(500).json({ messasge: "Internal Server Error" });
  }
};
...
export const logout = (req, res) => {
  try {
    ...
    console.log("Error in logout controller", error.messasge);
    res.status(500).json({ messasge: "Internal Server Error" });
  }
};
...
export const updateProfile = async (req, res) => {
  try {
    ...
    if (!profilePic) {
      return res.status(400).json({ messasge: "Profile Picture is Required" });
    }
    ...
    console.log("Error in Update Profile controller", error.messasge);
    res.status(500).json({ messasge: "Internal Server Error" });
  }
};
...
export const checkAuth = (req, res) => {
  try {
    ...
    console.log("Error in checkAuth controller", error.messasge);
    res.status(500).json({ messasge: "Internal Server Error" });
  }
};
